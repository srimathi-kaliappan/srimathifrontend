...
const App = () => {
  ...
  const getStudents=async()=>{
    const res=await axios.get("https://srimathibackend-4.onrender.com/students");
    setStudents(res.data);//tracking 
  };
  //post data
  const addStudent=async ()=>{
    await axios.post("https://srimathibackend-4.onrender.com/add",{
      name,course
  ...
  const deleteStudent=async(id) => {
    await axios.delete(`https://srimathibackend-4.onrender.com/delete/${id}`);//delete data in backend
